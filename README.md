...
***REMOVED******REMOVED*** 路径 B：Wrangler CLI（一行命令，无需 GitHub）

```bash
***REMOVED*** 安装（用 WorkBuddy 管理的 node）
/Users/<user>/.workbuddy/binaries/node/versions/22.22.2/bin/npx wrangler pages deploy . --project-name=xingtu1996
```
